...
public class Main {
    ...
    public static void main(String... args) {
        ...
        {
            guard.calculate();
            if(guard.mostOftenMinAsleepCount > longestTime)
            {
                guardTime = guard;
                longestTime = guard.mostOftenMinAsleepCount;
            }
        }

        System.out.println(guardTime + " most often asleep at min " + guardTime.mostOftenMinAsleep + " with a count of " + guardTime.mostOftenMinAsleepCount);
